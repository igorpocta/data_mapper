...
/**
 * Validates that a value is positive or zero (>= 0)
 */
#[Attribute(Attribute::TARGET_PROPERTY | Attribute::TARGET_PARAMETER)]
class PositiveOrZero implements AssertInterface
{
    ...
    public function validate(mixed $value, string $propertyName): ?string
    {
        ...
        return $this->message ?? "Property '{$propertyName}' must be positive or zero";
    }
}
