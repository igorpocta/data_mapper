...
/**
 * Validates that a datetime value is strictly before a given datetime
 */
#[Attribute(Attribute::TARGET_PROPERTY | Attribute::TARGET_PARAMETER)]
class DateTimeLessThan implements AssertInterface
{
    ...
    public function validate(mixed $value, string $propertyName): ?string
    {
        ...
        return $this->message ?? "Property '{$propertyName}' must be before {$this->threshold->format('Y-m-d H:i:s')}";
    }
}
